				...
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 6px #558998","borderColor":"#DCDFE6","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-model="detail.name" type="text" :readonly="ro.name" name="name" id="name" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
						...
						<div v-if="detail.value" class="layui-input-block">
							...
							<input :style='{"padding":"0 12px","boxShadow":"0 0 6px #558998","borderColor":"#DCDFE6","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="hidden" :value="detail.value" id="value" name="value" />
						</div>
						<div class="layui-input-block">
							<button v-if="!ro.value" :style='{"padding":"0 10px","boxShadow":"0 0 6px #558998","margin":"0 10px 0 0","borderColor":"#ccc","backgroundColor":"rgba(85, 137, 152, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="button" class="layui-btn btn-theme" id="valueUpload">
