			...
			<div class="data-add-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px #e6dfd3","margin":"30px auto","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"0","borderStyle":"solid"}'>
				...
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
						<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">材料编号：</label>
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 6px #558998","borderColor":"#DCDFE6","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-model="detail.cailiaobianhao" type="text" :readonly="ro.cailiaobianhao" name="cailiaobianhao" id="cailiaobianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
		                <label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">材料分类</label>
		                <div class="layui-input-block">
		                    <select name="cailiaofenlei" id="cailiaofenlei" lay-filter="cailiaofenlei"  >
		                        <option value="">请选择</option>
		                        <option v-for="(item,index) in cailiaofenlei" v-bind:key="index" :value="item">{{item}}</option>
		                    </select>
		                </div>
		            </div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
						...
						<div v-if="detail.tupian" class="layui-input-block">
							...
							<input :style='{"padding":"0 12px","boxShadow":"0 0 6px #558998","borderColor":"#DCDFE6","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' type="hidden" :value="detail.tupian" id="tupian" name="tupian" />
						</div>
						<div class="layui-input-block">
							<button v-if="!ro.tupian" :style='{"padding":"0 10px","boxShadow":"0 0 6px #558998","margin":"0 10px 0 0","borderColor":"#ccc","backgroundColor":"rgba(85, 137, 152, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="button" class="layui-btn btn-theme" id="tupianUpload">
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
						<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">单位：</label>
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 6px #558998","borderColor":"#DCDFE6","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-model="detail.danwei" type="text" :readonly="ro.danwei" name="danwei" id="danwei" autocomplete="off" class="layui-input">
						</div>
					</div>
		            
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
						<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">材料介绍：</label>
						<div class="layui-input-block">
							<textarea name="cailiaojieshao" id="cailiaojieshao">请输入材料介绍</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
					...
					var cailiaojieshao = tinymce.get('#cailiaojieshao').getContent()
					data.cailiaojieshao = cailiaojieshao;
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('zhuangxiucailiao/list', 'get', {
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('zhuangxiucailiao' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
