			...
			<div class="data-add-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px #e6dfd3","margin":"30px auto","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"0","borderStyle":"solid"}'>
				...
				<form class="layui-form layui-form-pane add" lay-filter="myForm">
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
						<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">工程名称：</label>
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 6px #558998","borderColor":"#DCDFE6","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-model="detail.gongchengmingcheng" type="text" :readonly="ro.gongchengmingcheng" name="gongchengmingcheng" id="gongchengmingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
		            ...
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
						<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">工程面积：</label>
						<div class="layui-input-block">
							<input :style='{"padding":"0 12px","boxShadow":"0 0 6px #558998","borderColor":"#DCDFE6","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","fontSize":"14px","borderStyle":"solid","height":"40px"}' v-model="detail.gongchengmianji" type="text" :readonly="ro.gongchengmianji" name="gongchengmianji" id="gongchengmianji" autocomplete="off" class="layui-input">
						</div>
					</div>
		            
		            <div :style='{"padding":"10px","boxShadow":"0 0 6px #e6dfd3","margin":"0 0 10px 0","borderColor":"rgba(230, 223, 211, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="layui-form-item" pane>
						<label :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">工程介绍：</label>
						<div class="layui-input-block">
							<textarea name="gongchengjieshao" id="gongchengjieshao">请输入工程介绍</textarea>
						</div>
					</div>
		...
		<script>
			...
			var vue = new Vue({
				...
				data: {
					...
					dataList: [],
					ro:{
                                        gongchengmingcheng : false,
                                        tupian : false,
                                        gongchengmianji : false,
                                        zhuangxiujiancai : false,
                                        gongchengjieshao : false,
					},
                    detail: {
                        gongchengmingcheng: '',
                        tupian: '',
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                if(http.getParam('corss')){
					...
					//form.val("myForm", obj);
					for(var o in obj){
                                        if(o=='gongchengmingcheng'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.gongchengmingcheng = true;
                                                continue;
                                        }
                                        if(o=='tupian'){
                                                vue.detail[o] = obj[o];
                                        ...
                                        if(o=='gongchengmianji'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.gongchengmianji = true;
                                                continue;
                                        }
                                        if(o=='zhuangxiujiancai'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.zhuangxiujiancai = true;
                                                continue;
                                        }
                                        if(o=='gongchengjieshao'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.gongchengjieshao = true;
                                                continue;
                                        }
					}
				}
				...
				form.on('submit(*)', function(data) {
					...
					var gongchengjieshao = tinymce.get('#gongchengjieshao').getContent()
					data.gongchengjieshao = gongchengjieshao;
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('gongchengxinxi/list', 'get', {
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('gongchengxinxi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
