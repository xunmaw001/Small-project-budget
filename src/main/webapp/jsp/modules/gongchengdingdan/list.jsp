...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">工程订单管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>工程订单管理</span></li>
								<li class="breadcrumb-item active"><span>工程订单列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">工程订单列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('baojia')">报价<i id="baojiaIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		var tableName = "gongchengdingdan";
		var pageType = "list";
	  	var searchForm = { key: ""};
		var pageIndex = 1;
		var pageSize = 10;
        ...
        function getDataList() {
			http("gongchengdingdan/page","GET",{
				page: pageIndex,
				limit: pageSize,
		...
		function setDataRow(item,number){
			...
			var baojiaCell  = document.createElement('td');

						 baojiaCell.innerHTML = item.baojia;

			row.appendChild(baojiaCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("gongchengdingdan/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("gongchengdingdan/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("gongchengdingdan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function getSum(colName){
		http("gongchengdingdan"+colName,"GET",{
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"gongchengdingdan");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"gongchengdingdan");
