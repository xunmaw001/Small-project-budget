...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑工程订单</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑工程订单</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">工程订单信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>报价</label>
										<input name="baojia" id="baojia" name="baojia" class="form-control" placeholder="报价">
									</div>
									<div class="form-group col-md-6">
										<label>下单时间</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "gongchengdingdan/info/" + id,
		...
		function submit() {
               //获取表单数据前取消禁用
                $("#xiadanshijian-input").attr('disabled',false);
				...
				if(crossrefid && crossuserid) {
					...
					http("gongchengdingdan/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("gongchengdingdan/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.baojia != null && res.data.baojia != ''){

						$("#baojia").val(res.data.baojia);
						$("#baojia").attr('readonly','readonly');
					}
		...
		function readonly(){
            if(window.sessionStorage.getItem('role')!="管理员") {
                ...
                $("#baojia").attr('readonly','readonly');
                $("#xiadanshijian-input").attr('disabled',true);
            }
		}
