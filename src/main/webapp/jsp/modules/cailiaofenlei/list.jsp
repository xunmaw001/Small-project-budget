...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">材料分类管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>材料分类管理</span></li>
								<li class="breadcrumb-item active"><span>材料分类列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">材料分类列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										材料分类
									</label>
									<input type="text" id="cailiaofenleiSearch" class="form-control form-control-sm" placeholder="请输入材料分类" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#cailiaofenleiSearch').val() != null && $('#cailiaofenleiSearch').val() != ''){
				searchForm.cailiaofenlei ="%" +  $('#cailiaofenleiSearch').val() + "%";
			}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("cailiaofenlei/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function getSum(colName){
		http("cailiaofenlei"+colName,"GET",{
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"cailiaofenlei");
