...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>材料类型</label>
										<input name="cailiaoleixing" id="cailiaoleixing" name="cailiaoleixing" class="form-control" placeholder="材料类型">
									</div>
									<div class="form-group col-md-6">
										<label>价格</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#cailiaoleixing").val(ruleForm.cailiaoleixing);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.cailiaoleixing != null && res.data.cailiaoleixing != ''){

						$("#cailiaoleixing").val(res.data.cailiaoleixing);
						$("#cailiaoleixing").attr('readonly','readonly');
					}
