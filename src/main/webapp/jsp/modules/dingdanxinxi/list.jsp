...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="cailiaoleixingSearch" class="form-control form-control-sm" placeholder="请输入材料类型" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('cailiaoleixing')">材料类型<i id="cailiaoleixingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#cailiaoleixingSearch').val() != null && $('#cailiaoleixingSearch').val() != ''){
				searchForm.cailiaoleixing ="%" +  $('#cailiaoleixingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("dingdanxinxi/page","GET",{
				...
				cailiaoleixing : searchForm.cailiaoleixing,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var cailiaoleixingCell  = document.createElement('td');

						 cailiaoleixingCell.innerHTML = item.cailiaoleixing;

			row.appendChild(cailiaoleixingCell);
